...
def plot_multi_TG(data_list, episodes, method_name_list, parameters, save=False):
    ...
    if budget > 10000:
        plt.title(parameters['title']+", b=+∞", parameters['title_font'])
    else:
...
def plot_multi_Budget(data_list, episodes, method_name_list, parameters, save=False):
    ...
    if budget > 10000:
        plt.title("Four Predators Catch One Prey, b=+∞", parameters['title_font'])
    else:
...
decay_dir_list = list_all_dir_name(dir_name_two) 
...
for i in decay_dir_list:
    if "AdhocTDActionReuseDecay" in i and "0.99 decay" in i:
        file_name0 = i
        method_name0 = "Decay-0.99"
    
    if "AdhocTDActionReuseDecay" in i and "0.95 decay" in i:
        file_name1 = i
        method_name1 = "Decay-0.95"
        
    if "AdhocTDActionReuseDecay" in i and "0.9 decay" in i:
        file_name2 = i
        method_name2 = "Decay-0.9"
        
    if "AdhocTDActionReuseDecay" in i and "0.8 decay" in i:
        file_name3 = i
        method_name3 = "Decay-0.8"

    if "AdhocTDActionReuseDecay" in i and "0.6 decay" in i:
        file_name4 = i
        method_name4 = "Decay-0.6"

    if "AdhocTDActionReuseDecay" in i and "0.4 decay" in i:
        file_name5 = i
        method_name5 = "Decay-0.4"
    ...
    if "AdhocTDActionReuseFixedLength" in i and "50 len" in i:
        file_name11 = i
        method_name11 = "FixedLength-50"
        
    if "AdhocTDActionReuseFixedLength" in i and "20 len" in i:
        file_name13 = i
        method_name13 = "FixedLength-20"
    
    if "AdhocTDActionReuseFixedLength" in i and "5 len" in i:
        file_name14 = i
        method_name14 = "FixedLength-5"
        
    if "AdhocTDActionReuseFixedLength" in i and "100 len" in i:
        file_name15 = i
        method_name15 = "FixedLength-100"
    
    
    if "AdhocTDActionReuseQChange" in i and "0.008 thre" in i:
        file_name16 = i
        method_name16 = "QChange-0.008"
...
parameters = {
    ...
    "linestyle": ['-', ":", "-.", "--", '-', ":", "-.", "--", '-', ":", "-.", "--", '-', ":", "-.", "--"],
    "linewidth": 2,
    'colors': ['#7570b3', '#e7298a', '#66a61e', '#e6ab02', 'magenta', 'teal', '#00FFFF', 'red'],
    'partPic': False,
    'yMinMax':[200, 700],
...
#================================== Q change ===============================
key_list = ['QChange-0.008', 'QChange-0.01', 'QChange-0.02', 'QChange-0.03', 'AdhocTD', 'Multi-IQL']
budget_list = ['QChange-0.008', 'QChange-0.01', 'QChange-0.02', 'QChange-0.03', 'AdhocTD']
...
"""
#================================== Q change ===============================
key_list = ['QChange-0.01', 'QChange-0.02', 'QChange-0.03', 'QChange-0.05', 'AdhocTD', 'Multi-IQL']
budget_list = ['QChange-0.01', 'QChange-0.02', 'QChange-0.03', 'QChange-0.05', 'AdhocTD']
parameters['save_name'] = 'q-change-'
...
#================================== Decay rate ===============================
key_list = ['Decay-0.99', 'Decay-0.95', 'Decay-0.9', 'Decay-0.8', 'AdhocTD', 'Multi-IQL']
budget_list = ['Decay-0.99', 'Decay-0.95', 'Decay-0.9', 'Decay-0.8', 'AdhocTD']
...
#================================== Fixed length ===============================
key_list = ['FixedLength-5', 'FixedLength-20', 'FixedLength-50', "FixedLength-100", 'Decay-0.95', 'AdhocTD', 'Multi-IQL']
budget_list = ['FixedLength-5', 'FixedLength-20', 'FixedLength-50', "FixedLength-100", 'Decay-0.95', 'AdhocTD']
...
#================================== ALL BEST COMPARE===============================
key_list = ['Decay-0.95', 'QChange-0.03', 'FixedLength-20', 'AdhocTD', 'Multi-IQL']
budget_list = ['Decay-0.95', 'QChange-0.03', 'FixedLength-20', 'AdhocTD']
